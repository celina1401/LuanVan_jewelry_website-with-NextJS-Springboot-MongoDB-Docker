...
//         const goldKey = `goldPrice_${meta.goldAge}`;
//         const goldPrice = typeof window !== 'undefined' ? Number(localStorage.getItem(goldKey)) : null;
//         if (goldPrice && !isNaN(goldPrice)) {
//           price = goldPrice * meta.weight + (meta.wage || 0);
//         }
//       }
