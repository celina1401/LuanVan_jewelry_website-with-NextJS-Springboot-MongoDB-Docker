...
const paymentMethods = [
  ...
  { label: "Thanh toán thẻ quốc tế (VISA, Master, JCB)", value: "card" },
  { label: "Trả góp thẻ tín dụng 0%", value: "installment" },
...
export default function OrderPage() {
  ...
  const discount = 0; // Có thể thêm logic mã ưu đãi sau
          ...
          <form onSubmit={handleOrder} className="space-y-6">
            ...
            <div className="bg-white dark:bg-[#18181b] rounded-xl shadow p-4 mb-4">
                    ...
                    <li key={item.id} className="flex items-center gap-3 justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-1 ml-2">
                          <button
                            type="button"
                            className="w-7 h-7 rounded bg-gray-200 dark:bg-gray-700 text-lg font-bold"
              ...
              <div className="mt-4 flex flex-col gap-2 text-sm">
                ...
                <div className="flex justify-between font-bold text-lg"><span>Tổng tiền</span><span>{total.toLocaleString()}₫</span></div>
              </div>
            ...
            <div className="bg-white dark:bg-[#18181b] rounded-xl shadow p-4">
              ...
              <div className="flex gap-4 mb-4">
                <button type="button" onClick={() => setDeliveryType("home")}
                  className={`flex-1 border rounded-lg p-3 flex flex-col items-center gap-1 ${deliveryType === "home" ? "bg-yellow-100 border-yellow-400" : "bg-gray-50 dark:bg-gray-900"}`}
                >
                ...
                <button type="button" onClick={() => setDeliveryType("store")}
                  className={`flex-1 border rounded-lg p-3 flex flex-col items-center gap-1 ${deliveryType === "store" ? "bg-purple-100 border-purple-400" : "bg-gray-50 dark:bg-gray-900"}`}
                >
            ...
            <div className="bg-white dark:bg-[#18181b] rounded-xl shadow p-4">
              ...
              <textarea
                ...
                placeholder="Vui lòng ghi chú thêm để T&C Jewelry hỗ trợ tốt nhất cho Quý khách!"
                value={note}
            ...
            <button
              type="submit"
              className="w-full bg-rose-500 text-white py-3 rounded font-bold text-lg hover:bg-rose-600 transition"
