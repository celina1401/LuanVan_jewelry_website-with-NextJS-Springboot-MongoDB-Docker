...
import com.example.fullstackapp.security.CustomAccessDeniedHandler;
import com.example.fullstackapp.security.JwtAuthenticationEntryPoint;
import com.example.fullstackapp.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    /**
     * Cấu hình SecurityFilterChain: CORS, CSRF, exception, session, authorize, JWT
     * resource server
     */
    @Bean
